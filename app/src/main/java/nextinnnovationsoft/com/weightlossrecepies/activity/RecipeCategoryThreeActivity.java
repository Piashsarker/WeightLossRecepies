...
public class RecipeCategoryThreeActivity extends AppCompatActivity {
    private RecyclerView mRecyclerView;
    private StaggeredGridLayoutManager mStaggeredLayoutManager;
    private RecipesCategoryAdapter mAdapter;
    private Intent intent;
    public static final String RECIPIE_CATEGORY_THREE_ACTIVITY = "RecipeCategoryFreeActivity";
    private List<Recipe> recipeList ;
    public static final String TAG = "tag";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recipe_category_three);
        intent =getIntent();
        recipeList = new ArrayList<>();
        recipeList = WeightLossRecipesDataSource.getRecipeCategoryThreeList();
    ...
    private void loadRecipesCategoryList() {
        ...
        mAdapter = new RecipesCategoryAdapter(this, data,RECIPIE_CATEGORY_THREE_ACTIVITY);
        ...
        mAdapter.setOnItemClickListener(new RecipesCategoryAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                intent = new Intent(RecipeCategoryThreeActivity.this, RecipeDetailsActivity.class);
                ...
                intent.putExtra(TAG,RECIPIE_CATEGORY_THREE_ACTIVITY);
