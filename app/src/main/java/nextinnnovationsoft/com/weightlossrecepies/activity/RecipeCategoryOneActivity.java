...
public class RecipeCategoryOneActivity extends AppCompatActivity {
    private RecyclerView mRecyclerView;
    private StaggeredGridLayoutManager mStaggeredLayoutManager;
    private RecipesCategoryAdapter mAdapter;
    private Intent intent;
    private List<Recipe> recipeList ;
    public static final String RECIPIE_CATEGORY_ONE_ACTIVITY = "RecipeCategoryOneActivity";
    public static final String TAG = "tag";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recipe_category_one);
        intent =getIntent();
        recipeList = new ArrayList<>();
        recipeList = WeightLossRecipesDataSource.getRecipeCategoryOneList();
    ...
    private void loadRecipesCategoryList() {
        ...
        mAdapter = new RecipesCategoryAdapter(this, data, RECIPIE_CATEGORY_ONE_ACTIVITY);
        ...
        mAdapter.setOnItemClickListener(new RecipesCategoryAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                intent = new Intent(RecipeCategoryOneActivity.this, RecipeDetailsActivity.class);
                ...
                intent.putExtra(TAG,RECIPIE_CATEGORY_ONE_ACTIVITY);
